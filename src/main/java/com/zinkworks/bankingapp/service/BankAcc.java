...
public class BankAcc implements MyBank {
    @Override
    public BankAccount balance(BankAccount sourceBankAccount) {

        if(sourceBankAccount.getCustomerId().equals("123") && sourceBankAccount.getCustomerName().equals("Ruth")){
            sourceBankAccount.setBalance(12345678);
        }
...
//    public String showMenu(BankAccount bankAccount) {
//        customerName = cname;
//        customerId = cid;
//        char option = '\0';
